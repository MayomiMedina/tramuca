        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 px-4 ">
                ...
                <?php
                        ...
                        if(empty($busqueda))
                        {
                            include("../php/buscar.cliente.php");
                        }
                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php 
                        $consul="SELECT *from tb_cliente WHERE DNI='$busqueda'";
...
<div class="modal fade" id="eliminarcliente" tabindex="-1" aria-labelledby="exampleModalLabelUp" aria-hidden="true">
...
<script>
    ...
    var elimi = document.getElementById('eliminarcliente')
    elimi.addEventListener('show.bs.modal', function(event) {
           ...
           var modalBodyInput = elimi.querySelector('#idcliente')
